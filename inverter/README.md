...
This is the analog example macro of the [HeiChips 2026 Analog Workshop](../README.md): the `inverter` cell with its complete flow (schematic → simulation → layout → DRC/LVS/PEX → characterization). The workshop walks through this flow step by step, see the [workshop website](https://heichips.github.io/heichips26-analog-workshop/).
