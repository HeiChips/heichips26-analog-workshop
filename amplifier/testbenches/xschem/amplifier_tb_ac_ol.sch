...
logy=0
linewidth_mult=4}
T {Design Testbench for AC OL analysis - Amplifier} 600 -1730 0 0 1 1 {}
...
C {amplifier.sym} 1120 -840 0 0 {name=x1}
C {amplifier.sym} 1120 -1260 0 0 {name=x2
spice_ignore=true}
C {amplifier_pex.sym} 1360 -1260 0 0 {name=x3
spice_ignore=true}
