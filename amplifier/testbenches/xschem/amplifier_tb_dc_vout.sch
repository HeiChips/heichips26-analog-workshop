...
color=4
node=i(VDD)}
T {Testbench for Output Voltage Swing analysis - Amplifier} 520 -1730 0 0 1 1 {}
...
N 1080 -800 1080 -760 {lab=GND}
N 1080 -960 1080 -920 {lab=VDD}
C {devices/code_shown.sym} 60 -1250 0 0 {name=NGSPICE
only_toplevel=true 
value="
.include ../../../netlist/pex/amplifier_magic_pex_3.spice
.param VDD=1.5
.csparam VDD=VDD
.param Vcm=VDD/2
.csparam Vcm=Vcm
...
C {amplifier.sym} 1080 -860 0 0 {name=x1
}
C {amplifier.sym} 1080 -1280 0 0 {name=x2
spice_ignore=true}
C {amplifier_pex.sym} 1320 -1280 0 0 {name=x3
spice_ignore=true}
