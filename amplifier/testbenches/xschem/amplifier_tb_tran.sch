...
linewidth_mult=3
autoload=0}
T {Testbench for transient analysis - Amplifier} 740 -1730 0 0 1 1 {}
...
C {amplifier.sym} 1100 -840 0 0 {name=x1}
C {amplifier.sym} 1100 -1260 0 0 {name=x2
spice_ignore=true}
C {amplifier_pex.sym} 1340 -1260 0 0 {name=x3
spice_ignore=true}
